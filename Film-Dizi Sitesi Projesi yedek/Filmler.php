...
<body>
        ...
        <div class="navbar-wrapper">
            ...
            <div class="menu-container">
                <ul class="menu-list">
                    ...
                    <li class="menu-list-item active">Filmler</li>
    ...
    <div class="container">
        <div class="content-wrapper">
            <div class="featured-content-Film">
                <img class="featured-title" src="img/STTT.png" alt="" />
                <p class="featured-desc">
                    Baş kahraman Luke Skywalker, kardeşi olduğu farkında olmadığı kardeşi Prenses Leia, kaçakçı Han Solo ve Darth Vader'ın kurtuluşunu konu alır.
                </p>
